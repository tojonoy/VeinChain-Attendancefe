import {
  ...
  useInput
} from "./chunk-VI4ESFS6.js";
import {
  useButton
} from "./chunk-2ZFQ4DKW.js";
import {
  areArraysEqual,
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(React6.Fragment, {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime4.jsxs)(React7.Fragment, {
...
var ListContext = React8.createContext(null);
if (true) {
...
function useTextNavigation(callback) {
  ...
  return React9.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React10.useCallback((event, value, reason) => {
  ...
  const stateComparers = React10.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React10.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React10.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React10.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React10.useRef([]);
  React10.useEffect(() => {
  ...
  const getItemState = React10.useCallback((item) => {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React11.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React11.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React12.createContext(null);
if (true) {
...
function useCompoundParent() {
  ...
  const registerItem = React12.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React12.useMemo(() => sortSubitems(subitems), [subitems]);
...
function useCompoundItem(id, itemMetadata) {
  const context = React13.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React13.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React14.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React14.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React14.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getItemDomElement = React14.useCallback((itemId) => {
  ...
  const reducerActionContext = React14.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
function MenuProvider(props) {
  ...
  const listContextValue = React15.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React15.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  return (0, import_jsx_runtime5.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime5.jsx)(ListContext.Provider, {
...
var Portal = React16.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime6.jsx)(React16.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime6.jsx)(React16.Fragment, {
...
function useMenuItem(params) {
  ...
  const itemMetadata = React18.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React18.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React19.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React19.useMemo(() => ({
    dispatch,
...
function useOption(params) {
  ...
  const id = useId(idParam);
  const optionRef = React21.useRef(null);
  const selectOption = React21.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  ...
  const localGetItemState = React22.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React22.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
function useSelect(props) {
  ...
  const optionValues = React24.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React24.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React24.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React24.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React24.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React24.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React24.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React24.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React24.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getOptionMetadata = React24.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React24.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function useSlider(parameters) {
  ...
  const touchId = React26.useRef(void 0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React26.useState(-1);
  ...
  const previousIndex = React26.useRef(void 0);
...
function useSnackbar(parameters = {}) {
  ...
  const handleResume = React27.useCallback(() => {
...
function useTabs(parameters) {
  ...
  const onSelected = React29.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React29.useRef(() => void 0);
  const getTabPanelId = React29.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React29.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React29.useCallback((lookupFunction) => {
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime9.jsx)(TabsContext.Provider, {
...
var Tabs = React32.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime10.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime10.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
function useTabPanel(parameters) {
  ...
  const metadata = React33.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React34.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React34.useCallback((tabValue) => {
  ...
  const handleChange = React34.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React34.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React34.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React34.useMemo(() => ({
  ...
  const contextValue = React34.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabRef = React36.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React36.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var TextareaAutosize = React37.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React37.useRef(null);
  const shadowRef = React37.useRef(null);
  const calculateTextareaStyles = React37.useCallback(() => {
  ...
  return (0, import_jsx_runtime13.jsxs)(React37.Fragment, {
    children: [(0, import_jsx_runtime12.jsx)("textarea", _extends({
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
      style
    }, other)), (0, import_jsx_runtime12.jsx)("textarea", {
      "aria-hidden": true,
...
var Badge = React38.forwardRef(function Badge2(props, forwardedRef) {
...
var Button = React39.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
var Input = React40.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime18.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime17.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
  }));
});
...
var _excluded8 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy"];
...
var Popup = React46.forwardRef(function Popup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime19.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime19.jsx)(PopupContext.Provider, {
      value: popupContextValue,
      children: (0, import_jsx_runtime19.jsx)(TransitionContext.Provider, {
        value: contextValue,
...
true ? Popup.propTypes = {
   ...
   */
  middleware: import_prop_types11.default.arrayOf(import_prop_types11.default.oneOfType([import_prop_types11.default.oneOf([false]), import_prop_types11.default.shape({
    fn: import_prop_types11.default.func.isRequired,
    name: import_prop_types11.default.string.isRequired,
    options: import_prop_types11.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types11.default.oneOfType([import_prop_types11.default.func, import_prop_types11.default.number, import_prop_types11.default.shape({
    alignmentAxis: import_prop_types11.default.number,
    crossAxis: import_prop_types11.default.number,
    mainAxis: import_prop_types11.default.number
  })]),
  /**
...
var Menu = React47.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && anchor == null) {
    return (0, import_jsx_runtime20.jsx)(Root, _extends({}, rootProps, {
      children: (0, import_jsx_runtime20.jsx)(Listbox, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime20.jsx)(MenuProvider, {
          value: contextValue,
          children
        })
      }))
  ...
  return (0, import_jsx_runtime20.jsx)(Popup, _extends({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
var _excluded11 = ["children", "disabled", "label", "id", "slotProps", "slots"];
...
var MenuItem2 = React49.forwardRef(function MenuItem3(props, ref) {
  ...
  return (0, import_jsx_runtime22.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime22.jsx)(InnerMenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
true ? MenuItem2.propTypes = {
   ...
   * @default false
   */
  disableFocusOnHover: import_prop_types14.default.bool,
  /**
...
var Modal = React50.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
  ...
  return (0, import_jsx_runtime23.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime24.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime23.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime23.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React50.cloneElement(children, childProps)
      })]
    }))
  });
});
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(React51.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React52.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React52.useMemo(() => {
    return {
      min: min3,
      max: max3,
      step,
  ...
  const controlledState = React52.useMemo(() => ({
    value: valueProp
  }), [valueProp]);
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React52.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React53.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime26.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime26.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime26.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React54.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime28.jsx)(List, _extends({}, listProps, {
...
var InnerOption = React55.memo(React55.forwardRef(function Option(props, forwardedRef) {
  ...
  const Root = (_slots$root = slots.root) != null ? _slots$root : "li";
  const optionRef = React55.useRef(null);
...
var Option2 = React55.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime30.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime30.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime31.jsx)(React56.Fragment, {
...
var Select = React56.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React56.Fragment, {
...
true ? Select.propTypes = {
  ...
  slotProps: import_prop_types20.default.shape({
    ...
    popup: import_prop_types20.default.oneOfType([import_prop_types20.default.func, import_prop_types20.default.object]),
  ...
  slots: import_prop_types20.default.shape({
    ...
    popup: import_prop_types20.default.elementType,
...
var _excluded17 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React57.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime33.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime33.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime34.jsxs)(React57.Fragment, {
...
true ? Slider.propTypes = {
   ...
   * @default 10
   */
  shiftStep: import_prop_types21.default.number,
  /**
...
var Snackbar = React58.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var _excluded22 = ["children", "value", "slotProps", "slots"];
...
var TabPanel = React62.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime42.jsx)(TabPanelRoot, _extends({}, tabPanelRootProps, {
...
function CssAnimation(props) {
  ...
  return (0, import_jsx_runtime45.jsx)("div", _extends({
...
true ? CssAnimation.propTypes = {
  ...
  enterAnimationName: import_prop_types28.default.string,
  enterClassName: import_prop_types28.default.string,
  exitAnimationName: import_prop_types28.default.string,
...
true ? CssTransition.propTypes = {
  ...
  lastTransitionedPropertyOnEnter: import_prop_types29.default.string,
  lastTransitionedPropertyOnExit: import_prop_types29.default.string
} : void 0;
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BK2QMEZM.js.map
