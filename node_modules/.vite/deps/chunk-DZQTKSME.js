...
For example, \`@sm\` or \`@600\` or \`@40rem/sidebar\`.` : formatMuiErrorMessage2(18, `(${shorthand})`));
    }
    return null;
  }
...
var ThemeContext2 = React23.createContext(null);
if (true) {
...
var RtlContext = React26.createContext();
...
function useDefaultProps({
  ...
  const ctx = React27.useContext(PropsContext);
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses3 = (ownerState, theme) => {
    ...
    return composeClasses3(slots, (slot) => generateUtilityClass(componentName, slot), {});
  };
  ...
  const Grid2 = React34.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React34.Children.map(children, (child) => {
        var _a;
        if (React34.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
function deepClone2(source) {
  if (React36.isValidElement(source) || (0, import_react_is5.isValidElementType)(source) || !isPlainObject3(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge3(target, source, options = {
  ...
  if (isPlainObject3(target) && isPlainObject3(source)) {
    Object.keys(source).forEach((key) => {
      if (React36.isValidElement(source[key]) || (0, import_react_is5.isValidElementType)(source[key])) {
        output[key] = source[key];
...
var ClassNameGenerator_default3 = ClassNameGenerator3;
...
function generateUtilityClass3(componentName, slot, globalStatePrefix = "Mui") {
    ...
    const traverse = (node, component) => {
      ...
      for (key in node) {
        ...
        if (stateClasses.includes(key) && Object.keys(child).length > 0) {
          if (true) {
            const stateClass = generateUtilityClass3("", key);
...
function generateUtilityClasses3(componentName, slots, globalStatePrefix = "Mui") {
  const result = {};
  slots.forEach((slot) => {
    result[slot] = generateUtilityClass3(componentName, slot, globalStatePrefix);
  });
  return result;
}
...
var svgIconClasses = generateUtilityClasses3("MuiSvgIcon", ["root", "colorPrimary", "colorSecondary", "colorAction", "colorError", "colorDisabled", "fontSizeInherit", "fontSizeSmall", "fontSizeMedium", "fontSizeLarge"]);
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types24.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types24.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types25.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types26.default.oneOfType([import_prop_types26.default.func, import_prop_types26.default.object]);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DZQTKSME.js.map
